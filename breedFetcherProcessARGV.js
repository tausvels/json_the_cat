...
const query = {};
const fetchBreedDescription = function(endpoint, callback) {
...
rl.question("Enter breed name ", answer => {
  ...
  let endpoint = `https://api.thecatapi.com/v1/images/search?breed_ids=${userInput}`;
  rl.close();
  fetchBreedDescription(endpoint, catData => {
